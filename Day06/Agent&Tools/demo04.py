...
def calculator(expression):
    """
    This calculator function solves any arithmetic expession containing all constant values.
...
def get_weather(city):
    ...
    If weather cannot found,then return 'error'.
